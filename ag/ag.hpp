...
auto avg(ag::Variable<N, M, O> const& variable) {
...
auto matmul(ag::Variable<N, M, OL> const& left, ag::Variable<M, O, OR> const& right) {
...
auto operator+(ag::Variable<N, M, OL> const& left, ag::Variable<N, M, OR> const& right) {
